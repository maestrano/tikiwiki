{* $Id: blog_post_postbody_content.tpl 44893 2013-02-15 17:10:22Z jonnybradley $ *}
{if $blog_post_context eq 'view_blog' && $use_excerpt eq 'y' && !empty($post_info.parsed_excerpt)}
