{* $Id: tiki-admin_menu_options.tpl 46174 2013-06-05 15:49:33Z jonnybradley $ *}
		...
		<tr>
			<td valign="top" class="odd">
				...
				<div style="text-align:right;position:relative;">
					...
					<div id="weburls" style="display:none;position:absolute;right:-10px;top:-50px;z-index:1;" class="box">
						<table>
							<tr>
								<td valign="top" id="urltop">
									<h2>{tr}Some useful URLs{/tr}</h2>
									<div style="text-align: right;">
										<a href="#" onclick="flip('weburls');return false;">{tr}Hide Quick Urls{/tr}</a>
									</div>
								</td>
							</tr>
							<tr>
